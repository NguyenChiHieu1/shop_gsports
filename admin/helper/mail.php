...
function maill($tenNguoinhan,$emailNguoinhan,$subject,$content){
    ...
    try {
        ...
        $mail->Username = 'tamchuong98@gmail.com';                 // SMTP username
        $mail->Password = 'sieunhancutoi';                           // SMTP password
        $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 465;                                    // TCP port to connect to

        //Recipients
        $mail->setFrom('lyquynh59@gmail.com', 'THE HELMET SHOP');
        $mail->addAddress($emailNguoinhan,$tenNguoinhan);     // Add a recipient
        //$mail->addAddress('duc.huu128@gmail.com');               // Name is optional
        $mail->addReplyTo('lyquynh59@gmail.com', 'THE HELMET SHOP');
