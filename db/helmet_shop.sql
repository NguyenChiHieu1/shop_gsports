...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_DOANH_THU` (IN `ngaybatdau` DATE, IN `ngayketthuc` DATE)  NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_GIAO_HANG` (IN `maquan` VARCHAR(20) CHARSET utf8)  NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_LOI_NHUAN` (IN `ngaybatdau` DATE)  NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_SAN_PHAM_BAN` (IN `ngaybatdau` DATE, IN `ngayketthuc` DATE)  NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_TON_KHO` (IN `ngaybatdau` DATE)  NO SQL
...
CREATE TABLE `bills` (
  `bill_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
('HD-180', '2020-12-23', NULL, 180),
('HD-181', '2020-12-23', NULL, 181),
('HD-182', '2020-12-23', NULL, 182),
('HD-183', '2020-12-23', NULL, 183),
('HD-184', '2020-12-23', NULL, 184),
('HD-185', '2020-12-23', NULL, 185),
('HD-190', '2020-12-25', NULL, 190),
('HD-192', '2020-12-25', NULL, 192),
('HD-194', '2020-12-25', NULL, 194),
('HD-195', '2020-12-28', NULL, 195),
('HD-196', '2020-12-28', NULL, 196),
('HD-197', '2020-12-28', NULL, 197),
('HD-198', '2020-12-28', NULL, 198),
('HD-199', '2020-12-29', NULL, 199),
('HD-200', '2020-12-29', NULL, 200),
('HD-201', '2020-12-29', NULL, 201);
...
CREATE TABLE `categories` (
  `cate_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `comment` (
  `cmt_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `contents` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `comment_customer` (
  ...
  `comment_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `contents` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `customers` (
  ...
  `gender` enum('Nam','Nữ') COLLATE utf8_unicode_ci DEFAULT NULL,
  `address` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `district_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `status` enum('0','1') COLLATE utf8_unicode_ci NOT NULL COMMENT '0=Chưa kích hoạt\r\n1=Đã kích hoạt',
...
(6, 'phipgn', 'phipgn@gmail.com', '123456', 'Gia Phi', 'Nam', '123 Lò Lu 3', 'Q09', '0982769791', '1', 5),
(38, 'phipgn2', 'phipgn2@gmail.com', '123456', 'Gia Phi', 'Nam', '123 Lo Lu', 'HBC', '0123123123', '0', 5),
(39, 'hoailinh', 'hoailinh@gmail.com', '123456', 'Hoài Linh', 'Nam', '30 Phường 2 ', 'QBTH', '0333789987', '0', 5),
(41, 'hongtham', 'hongtham@gmail.com', '123456', 'Hồng Thắm', 'Nữ', '123 Lê Văn Việt', 'QGV', '0333344466', '1', 5),
(46, 'lyquynh', 'lyquynh59@gmail.com', '123456', 'Lý Quỳnh', 'Nữ', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '1', 5),
(49, 'Tham98', 'phamtram291195@gmail.com', '123456', 'Hồng Thắm', 'Nữ', '37 Lý Thường Kiệt', 'QBTH', '0333639679', '1', 5),
(53, 'Quynh98', 'quynhfl39@gmail.com', '123456', 'Phạm Quỳnh', 'Nữ', '144 Man Thiện, Hiệp Phú', 'Q09', '0333347268', '1', 5);
...
CREATE TABLE `employee` (
  ...
  `password` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `gender` enum('Nam','Nữ') COLLATE utf8_unicode_ci NOT NULL,
  `address` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'admin', 'admin@gmail.com', '123456', 'Lam Trường', 'Nam', '45/97 đường 13 Phường Long Phước, Quận 9', '0333836633', 1, 1),
(2, 'manager', 'manager@gmail.com', '123456', 'Gia Phi', 'Nữ', '97 Man Thiện, Phường Hiệp Phú, Quận 9', '0333836638', 1, 2),
(3, 'chaukietluan', 'chaukietluan@gmail.com', '123456', 'Châu Kiệt Luân', 'Nam', '123, Phường 7, Quận 1', '0333222444', 1, 4),
(4, 'sontung', 'sontung@gmail.com', '123456', 'Sơn Tùng', 'Nam', '165 Tô Ngọc Vân, Quận Thủ Đức', '0394000123', 1, 4),
(5, 'ducphuc', 'ducphuc@gmail.com', '123456', 'Đức Phúc', 'Nam', 'D18, Phường An Phú, Quận 2', '0333836632', 1, 4),
(6, 'vinhhung', 'damvinhhung@gmail.com', '123456', 'Đàm Vĩnh Hưng', 'Nam', '215 Phường 4, Quận 5', '0333375123', 1, 4),
(7, 'approver', 'approver@gmail.com', '123456', 'Đan Trường', 'Nam', '272, Phường 6, Quận 3', '0333484725', 1, 3),
(8, 'khacviet', 'khacviet@gmail.com', '123456', 'Khắc Việt', 'Nam', ' 54 Đường Nguyễn Văn Thủ, Đa Kao, Quận 1', '0373484296', 1, 4);
...
CREATE TABLE `function` (
  ...
  `display_on_homepage` enum('0','1') COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `function_categories` (
  ...
  `cate_name` varchar(100) COLLATE utf8mb4_vietnamese_ci NOT NULL,
...
CREATE TABLE `import` (
  `import_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  `id_employee` int(12) NOT NULL,
  `total` float NOT NULL,
  `place_order_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
('20201222122245', '2020-12-22 12:22:53', 1, 1025.44, '20201222120135'),
('20201222122300', '2020-12-22 12:23:16', 1, 2694.64, '20201222115824'),
('20201222122349', '2020-12-22 12:24:03', 1, 4366, '20201222114707'),
('20201223101237', '2020-12-23 10:13:04', 1, 173.4, '20201223101053'),
('20201223101413', '2020-12-23 10:15:03', 1, 338.6, '20201223100829'),
('20201223185936', '2020-12-23 18:59:39', 1, 156, '20201223185913'),
('20201228215441', '2020-12-28 21:55:23', 1, 214.4, '20201228215259'),
('20201229150659', '2020-12-29 15:07:35', 1, 355, '20201229150409');
...
(180, 46, 1, 8, '2020-12-22 12:39:15', 'Lý Quỳnh', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-25', 3, 196.84),
(181, 46, 1, 6, '2020-12-22 12:42:09', 'Thanh Vinh', '88 Song Hành, An Phú', 'Q02', '0969399121', '2020-12-25', 3, 135.74),
(182, 46, 1, 5, '2020-12-22 12:45:26', 'Anh Quân', '254 Hòa Hảo, Phường 4', 'Q10', '0986624416', '2020-12-24', 3, 344.4),
(183, 46, 1, 8, '2020-12-22 12:53:41', 'Mỹ Kiều', '869 Âu Cơ, Tân Sơn Nhì', 'QTP', '0335998119', '2020-12-25', 3, 81.05),
(184, 53, 1, 4, '2020-12-23 17:37:06', 'Minh Duy', '80 Đường Số 23, Phường 10', 'Q06', '0333347268', '2020-12-26', 3, 87.4),
(185, 53, 1, 4, '2020-12-23 17:49:25', 'Hồng Sương', '504 Nguyễn Tất Thành, Phường 18', 'Q04', '0333347268', '2020-12-26', 3, 30.24),
(186, 53, 1, 5, '2020-12-23 18:02:18', 'Hồng Thắm', '6 Nguyễn Lương Bằng, Tân Phú', 'Q07', '0333347268', '2020-12-26', 3, 26.32),
(187, 53, 1, 5, '2020-12-23 18:30:54', 'Phạm Quỳnh', '144 Man Thiện, Hiệp Phú', 'Q09', '0333347268', '2020-12-26', 3, 70.89),
(188, 46, NULL, NULL, '2020-12-24 11:10:32', 'Lý Quỳnh', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-27', 4, 36.4),
(189, 46, 1, 1, '2020-12-24 20:45:53', 'Minh Anh', '123 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-27', 4, 38.05),
(190, 46, 1, 8, '2020-12-24 20:49:43', 'Hoàng Thương', '45 Đường 12, Long Phước', 'Q09', '0333639679', '2020-12-27', 3, 47.88),
(191, 46, 1, 1, '2020-12-25 05:31:33', 'Thiên An', '103 Đường Lê Thị Hoa, Bình Chiểu', 'QTD', '0333639679', '2020-12-28', 4, 89.97),
(192, 46, 1, 4, '2020-12-25 07:27:03', 'Kim Long', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-28', 3, 48.16),
(193, 46, 1, 8, '2020-12-25 07:29:44', 'Lan Anh', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-28', 3, 120.12),
(194, 46, 1, 5, '2020-12-25 07:33:54', 'Linh Chi', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-28', 3, 80.14),
(195, 46, 1, 5, '2020-12-25 08:02:59', 'Lý Quỳnh', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-27', 3, 120.96),
(196, 46, 1, 4, '2020-12-26 21:26:40', 'Thanh Tâm', '22 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-29', 3, 76.1),
(197, 46, 1, 8, '2020-12-28 11:19:32', 'Lan Phương', '56 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2020-12-31', 3, 59.98),
(198, 46, 1, 6, '2020-12-28 22:09:06', 'Ngọc Tú', '2 Võ Oanh, Phường 25', 'QBTH', '0333639679', '2020-12-31', 3, 156.18),
(199, 46, 1, 8, '2020-12-29 13:17:28', 'Lý Quỳnh', '97 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2021-01-01', 3, 87.92),
(200, 46, 1, 8, '2020-12-29 13:25:05', 'Linh Chi', '56 Man Thiện, Phường Hiệp Phú', 'Q09', '0333639679', '2021-01-01', 3, 132.78),
(201, 46, 1, 8, '2020-12-29 14:40:48', 'Thanh Tuyền', '1 Võ Văn Ngân, Linh Chiểu', 'QTD', '0333639679', '2021-01-01', 3, 123.8);
...
CREATE TABLE `place_order` (
  ...
  `created_at` datetime NOT NULL,
  `id_employee` int(12) NOT NULL,
  `supp_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `import_code` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
...
('20201222114707', '2020-12-22 11:57:00', 1, 'S189', '20201222122349', 1),
('20201222115824', '2020-12-22 12:00:44', 1, 'P247', '20201222122300', 1),
('20201222120135', '2020-12-22 12:18:17', 1, 'ASA', '20201222122245', 1),
('20201223100829', '2020-12-23 10:10:36', 1, 'S189', '20201223101413', 1),
('20201223101053', '2020-12-23 10:12:20', 1, 'ASA', '20201223101237', 1),
('20201223185913', '2020-12-23 18:59:30', 1, 'ASA', '20201223185936', 1),
('20201224174806', '2020-12-24 17:48:19', 1, 'S189', NULL, 2),
('20201226104547', '2020-12-26 10:45:57', 1, 'S189', NULL, 2),
('20201228215259', '2020-12-28 21:53:52', 1, 'ASA', '20201228215441', 1),
('20201229150409', '2020-12-29 15:05:23', 1, 'ASA', '20201229150659', 1),
('DH001', '2020-12-24 17:49:03', 1, 'ASA', NULL, 2);
...
CREATE TABLE `products` (
  ...
  `cate_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `supp_code` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `promotion` (
  `promotion_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
('KM01', '2020-12-01', '2021-01-31', 'Khuyến mãi cuối năm', 1),
('KM02', '2021-02-01', '2021-02-28', 'Khuyễn mãi đầu năm mới', 1);
...
CREATE TABLE `returns_product_detail` (
  `return_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `product_code` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
...
('AH1', 'Asian Helmet', '126 d12 quận 8', 'asianhelmet@gmail.com', '0333224455', 1),
('ASA', 'ASA Helmet', '11, Phường Bến Nghé, Quận 1, TP.HCM', 'asa_helmet1@gmail.com', '0333444555', 1),
('P247', 'Phượt 247', '589C An Phú, Quận 2, Tp.HCM', 'phuot247@gmail.com', '0333444666', 1),
('S189', 'Store 189', '25 Cao Thắng, Phường 5, Quận 3, Tp.HCM', 'store_189@gmail.com', '0333444777', 1);
...
--
-- Constraints for table `returns_product`
--
ALTER TABLE `returns_product`
  ADD CONSTRAINT `returns_product_ibfk_1` FOREIGN KEY (`bill_code`) REFERENCES `bills` (`bill_code`),
  ADD CONSTRAINT `returns_product_ibfk_2` FOREIGN KEY (`id_employee`) REFERENCES `employee` (`id`);

--
-- Constraints for table `returns_product_detail`
--
ALTER TABLE `returns_product_detail`
  ADD CONSTRAINT `returns_product_detail_ibfk_1` FOREIGN KEY (`product_code`) REFERENCES `products` (`product_code`),
  ADD CONSTRAINT `returns_product_detail_ibfk_2` FOREIGN KEY (`return_code`) REFERENCES `returns_product` (`return_code`);
COMMIT;
